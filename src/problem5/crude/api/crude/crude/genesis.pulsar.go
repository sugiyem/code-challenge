...
func (x *GenesisState) slowProtoReflect() protoreflect.Message {
	mi := &file_crude_crude_genesis_proto_msgTypes[0]
...
func (x *fastReflection_GenesisState) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		...
		panic(fmt.Errorf("message crude.crude.GenesisState does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_GenesisState) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message crude.crude.GenesisState does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_GenesisState) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in crude.crude.GenesisState", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: crude/crude/genesis.proto
...
func (*GenesisState) Descriptor() ([]byte, []int) {
	return file_crude_crude_genesis_proto_rawDescGZIP(), []int{0}
}
...
var file_crude_crude_genesis_proto_rawDesc = []byte{
	0x0a, 0x19, 0x63, 0x72, 0x75, 0x64, 0x65, 0x2f, 0x63, 0x72, 0x75, 0x64, 0x65, 0x2f, 0x67, 0x65,
	0x6e, 0x65, 0x73, 0x69, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0b, 0x63, 0x72, 0x75,
	0x64, 0x65, 0x2e, 0x63, 0x72, 0x75, 0x64, 0x65, 0x1a, 0x11, 0x61, 0x6d, 0x69, 0x6e, 0x6f, 0x2f,
...
var (
	file_crude_crude_genesis_proto_rawDescOnce sync.Once
	file_crude_crude_genesis_proto_rawDescData = file_crude_crude_genesis_proto_rawDesc
)

func file_crude_crude_genesis_proto_rawDescGZIP() []byte {
	file_crude_crude_genesis_proto_rawDescOnce.Do(func() {
		file_crude_crude_genesis_proto_rawDescData = protoimpl.X.CompressGZIP(file_crude_crude_genesis_proto_rawDescData)
	})
	return file_crude_crude_genesis_proto_rawDescData
}

var file_crude_crude_genesis_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
...
func file_crude_crude_genesis_proto_init() {
	if File_crude_crude_genesis_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_crude_crude_genesis_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_crude_crude_genesis_proto_goTypes,
		DependencyIndexes: file_crude_crude_genesis_proto_depIdxs,
		MessageInfos:      file_crude_crude_genesis_proto_msgTypes,
	}.Build()
	File_crude_crude_genesis_proto = out.File
	file_crude_crude_genesis_proto_rawDesc = nil
	file_crude_crude_genesis_proto_goTypes = nil
	file_crude_crude_genesis_proto_depIdxs = nil
}
